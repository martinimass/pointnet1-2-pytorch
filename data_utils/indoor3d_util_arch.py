...
DATA_PATH = os.path.join(ROOT_DIR, 'data','arch-conv')
g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta_arch/class_names.txt'))]
...
g_easy_view_labels = [0,1,3,5,7,8]
