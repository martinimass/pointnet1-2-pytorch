...
if __name__ == '__main__':
    data_root = '../data/arch-npy/'
    num_point, test_area, block_size, sample_rate = 4096, 5, 1.0, 0.01

    point_data = ArCHDataset(split='train', data_root=data_root, num_point=num_point, test_area=test_area, block_size=block_size, sample_rate=sample_rate, transform=None)
