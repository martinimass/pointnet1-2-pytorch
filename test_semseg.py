...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='ArCH', metavar='N', choices=['S3DIS', "ArCH"])
...
def main(args):
    ...
    if args.dataset == "S3DIS":
        ...
        from data_utils.ArCHDataLoader import ScannetDatasetWholeScene
        TEST_DATASET_WHOLE_SCENE = ScannetDatasetWholeScene(root, split='test', test_area=args.test_area,
                                                            block_points=NUM_POINT)
        from data_utils.indoor3d_util_arch import g_label2color
