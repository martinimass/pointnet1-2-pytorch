...
Modified by: Massimo Martini, March 2021
"""
import argparse
import os
import torch
...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='S3DIS', metavar='N', choices=['S3DIS', "ArCH"])
...
def main(args):
    ...
    if args.dataset=="S3DIS":
        ...
        from data_utils.ArCHDataLoader import ArCHDataset
        print("start loading training data ...")
        TRAIN_DATASET = ArCHDataset(split='train', data_root=root, num_point=NUM_POINT, test_area=args.test_area,
                                     block_size=1.0, sample_rate=1.0, transform=None)
        print("start loading test data ...")
        TEST_DATASET = ArCHDataset(split='test', data_root=root, num_point=NUM_POINT, test_area=args.test_area,
                                    block_size=1.0, sample_rate=1.0, transform=None)
